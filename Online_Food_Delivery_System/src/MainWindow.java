...
public class MainWindow extends javax.swing.JFrame {
   ...
   static String orderTypeChoose="delivery";
    ...
    private void initComponents() {
        ...
        setTitle("Online_Food_Delivery_System");
        setName("");
        ...
        FoodCategory_jList.setFont(new java.awt.Font("Tahoma", 3, 14)); 
        ...
        Delivery_button.setFont(new java.awt.Font("Tahoma", 1, 13)); 
        ...
        PickUp_button.setFont(new java.awt.Font("Tahoma", 1, 13)); 
        ...
        title_Label.setFont(new java.awt.Font("Tahoma", 3, 24)); 
        ...
        food1_jButton.setFont(new java.awt.Font("Tahoma", 1, 11)); 
        food1_jButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/TodaySpecial/allo-paratha1.jpg"))); 
        food1_jButton.setText("Allo Paratha");
        ...
        foodPrice1_jLabel.setFont(new java.awt.Font("Tahoma", 1, 12)); 
        foodPrice1_jLabel.setForeground(new java.awt.Color(0, 0, 255));
        foodPrice1_jLabel.setText("Price: ");

        food2_jButton.setFont(new java.awt.Font("Tahoma", 1, 11)); 
        food2_jButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/TodaySpecial/chhat1.jpg"))); 
        food2_jButton.setText("Chats");
        ...
        food3_jButton.setFont(new java.awt.Font("Tahoma", 1, 11)); 
        food3_jButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/TodaySpecial/Coconut-Barfi1.jpg"))); 
        food3_jButton.setText("Coconut Barfi");
        ...
        food4_jButton.setFont(new java.awt.Font("Tahoma", 1, 11)); 
        food4_jButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/TodaySpecial/Dal-Makhani1.jpg"))); 
        food4_jButton.setText("Dal Makhani");
        ...
        food5_jButton.setFont(new java.awt.Font("Tahoma", 1, 11)); 
        food5_jButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/TodaySpecial/Dhokla1.jpg"))); 
        food5_jButton.setText("Dhokla");
        ...
        food6_jButton.setFont(new java.awt.Font("Tahoma", 1, 11)); 
        food6_jButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/TodaySpecial/masala_dosa1.jpg"))); 
        food6_jButton.setText("Masala Dosa");
        ...
        Category_jLabel.setFont(new java.awt.Font("Tahoma", 3, 16)); 
        ...
        foodPrice1_jTextField.setText(" ₹60.50");

        foodPrice2_jLabel.setFont(new java.awt.Font("Tahoma", 1, 12)); 
        ...
        foodPrice2_jTextField.setText(" ₹50.50");

        foodPrice3_jLabel.setFont(new java.awt.Font("Tahoma", 1, 12)); 
        ...
        foodPrice3_jTextField.setText(" ₹70.00");

        foodPrice4_jLabel.setFont(new java.awt.Font("Tahoma", 1, 12)); 
        ...
        foodPrice4_jTextField.setText(" ₹40.50");

        foodPrice5_jLabel.setFont(new java.awt.Font("Tahoma", 1, 12)); 
        ...
        foodPrice5_jTextField.setText(" ₹60.50");

        foodPrice6_jLabel.setFont(new java.awt.Font("Tahoma", 1, 12)); 
        ...
        foodPrice6_jTextField.setText(" ₹50.00");

        feelHungry_jButton.setFont(new java.awt.Font("Tahoma", 3, 13)); 
        ...
        exit_jButton.setFont(new java.awt.Font("Tahoma", 1, 12)); 
        ...
        SignIn_button.setFont(new java.awt.Font("Tahoma", 3, 14)); 
        ...
        MyOrderList_button.setFont(new java.awt.Font("Tahoma", 3, 14)); 
        ...
        MyAccount_button.setFont(new java.awt.Font("Tahoma", 3, 14)); 
        ...
        logo_jLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/star8.jpg"))); 
    ...
    private void PickUp_buttonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void MyOrderList_buttonActionPerformed(java.awt.event.ActionEvent evt) {
         new SummaryJDialog(new javax.swing.JFrame(), true).createSummaryJDialog();
    }

    private void food2_jButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void food3_jButtonActionPerformed(java.awt.event.ActionEvent evt) {
          if(signInState.equals("in")){ 
        FoodItemJDialog dialog = new FoodItemJDialog(new javax.swing.JFrame(), true);
        ReadXMLDataBase data =new ReadXMLDataBase();
    ...
    private void food4_jButtonActionPerformed(java.awt.event.ActionEvent evt) {
           if(signInState.equals("in")){ 
        FoodItemJDialog dialog = new FoodItemJDialog(new javax.swing.JFrame(), true);
        ReadXMLDataBase data =new ReadXMLDataBase();
    ...
    private void food1_jButtonActionPerformed(java.awt.event.ActionEvent evt) {
         if(signInState.equals("in")){ 
        FoodItemJDialog dialog = new FoodItemJDialog(new javax.swing.JFrame(), true);
        ReadXMLDataBase data =new ReadXMLDataBase();
    ...
    private void food5_jButtonActionPerformed(java.awt.event.ActionEvent evt) {
         if(signInState.equals("in")){ 
        FoodItemJDialog dialog = new FoodItemJDialog(new javax.swing.JFrame(), true);
        ReadXMLDataBase data =new ReadXMLDataBase();
    ...
    private void food6_jButtonActionPerformed(java.awt.event.ActionEvent evt) {
         if(signInState.equals("in")){ 
        FoodItemJDialog dialog = new FoodItemJDialog(new javax.swing.JFrame(), true);
        ReadXMLDataBase data =new ReadXMLDataBase();
    ...
    private void FoodCategory_jListValueChanged(javax.swing.event.ListSelectionEvent evt) {
    ...
    private void Delivery_buttonActionPerformed(java.awt.event.ActionEvent evt) {
        orderTypeChoose ="delivery";
    }

    private void MyAccount_buttonActionPerformed(java.awt.event.ActionEvent evt) {
        UserAccount Udialog = new UserAccount(new javax.swing.JFrame(), true);
        Udialog.createUserAccountDialog();
    }

    private void exit_jButtonActionPerformed(java.awt.event.ActionEvent evt) {
        System.exit(0);
    }

    private void feelHungry_jButtonActionPerformed(java.awt.event.ActionEvent evt) {
